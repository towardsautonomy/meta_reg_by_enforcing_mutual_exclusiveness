...
if __name__ == '__main__':
    ...
    csv_files = ['logs/cls_20.mbs_25.k_shot_1.inner_numstep_1.meta_lr_0.0025.inner_updatelr_0.04.learn_inner_update_lr_False.dataset_omniglot.mutual_exclusive_True.csv',
                 'logs/cls_20.mbs_25.k_shot_1.inner_numstep_1.meta_lr_0.0025.inner_updatelr_0.04.learn_inner_update_lr_False.dataset_omniglot.mutual_exclusive_False.csv']

    legends = ['pre-optim raw plot (mutual-exclusive)',
               'pre-optim moving avarage (mutual-exclusive)',
               'post-optim raw plot (non-mutual-exclusive)',
               'post-optim moving avarage (non-mutual-exclusive)']
